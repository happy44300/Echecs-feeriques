...
Ceci est un projet de L1 ayant pour but de créer une WebApp pour jouer aux echecs féériques. Pour ce faire nous avons utilisé AngularJS, typescript et réalisé des tests unitaires
